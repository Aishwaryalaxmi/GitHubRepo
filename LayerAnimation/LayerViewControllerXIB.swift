...
class LayerViewControllerXIB: UIViewController {
...
//        circleShapeLayer2?.anchorPoint = CGPoint(x: 0.5, y: 0.5)
        ...
        let arcCenter2 = CGPoint(x: UIScreen.main.bounds.width/2, y: UIScreen.main.bounds.height/2)
        let radius2 = (UIScreen.main.bounds.width)/2.0
        let startAngle2 = CGFloat(0)
        let endAngle2 =  CGFloat(Double.pi)
        let clockwise2 =  true
